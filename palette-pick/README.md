...
Run: any static server, rooted at the repo one level up rather than at this
folder — `python3 -m http.server 8080`, then
`http://localhost:8080/palette-pick/`. The SDK, the page chrome and the font
are loaded from `../`. Zero build, zero deps.
