...
(function () {
  ...
  /* The press that owns the current stroke is provably no longer down.
     ...
     already gone. Measured: one lost touch release left activePointer set
     against an id nothing could match again, so every later press on the sheet
     was swallowed and undo ↩ (which refuses to run mid-press) went with it —
     the canvas was dead until clear ✕ or "new round". */
