...
/* Each entry:
   ...
   level   — how much the drill asks of a beginner's hand, 1|2|3:
             1 = tap-or-drag judgement, a quick win on any hardware
             2 = a standard stroke or multi-step drill
             3 = construction: multi-stroke 3D or heavy abstraction
             The daily warmup SERVES its three easiest-first (pickForKey
             sorts by this after picking) — level never changes WHICH
             three a day asks for, only the order they are offered in,
             so the triple stays comparable and the checklist stops
             opening day 2 with Box Check.
...
window.ARTDAILY_GAMES = [
  ...
  /* ---- colour ---- */
  {
    ...
    cat: 'colour', tag: 'auto', minutes: 4, level: 2,
    status: 'live',
  },
  {
    ...
    cat: 'colour', tag: 'fit', minutes: 3, level: 2,
    status: 'live',
  },
  {
    ...
    cat: 'colour', tag: 'auto', minutes: 3, level: 2,
    status: 'live',
  },
  {
    ...
    cat: 'colour', tag: 'auto', minutes: 2, level: 1,
    status: 'live',
  },
  {
  ...
  /* ---- value & light ---- */
  {
    ...
    icon: '🌗', accent: 'sunny', skills: ['values', 'colors'],
    cat: 'value', tag: 'auto', minutes: 3, level: 2,
    status: 'live',
  },
  {
    ...
    cat: 'value', tag: 'soft', minutes: 4, level: 3,
    status: 'live',
  },
  {
    ...
    cat: 'value', tag: 'fit', minutes: 4, level: 3,
    status: 'live',
  },
  {
    ...
    cat: 'value', tag: 'fit', minutes: 3, level: 2,
    status: 'live',
  },
  {
    ...
    cat: 'value', tag: 'auto', minutes: 2, level: 1,
    status: 'live',
  },
  ...
  /* ---- line & hand ---- */
  {
    ...
    cat: 'line', tag: 'auto', minutes: 2, level: 1,
    status: 'live',
  },
  {
    ...
    cat: 'line', tag: 'auto', minutes: 3, level: 2,
    status: 'live',
  },
  {
  ...
  },
  {
    ...
    cat: 'line', tag: 'fit', minutes: 3, level: 2,
    status: 'live',
  },
  {
    ...
    cat: 'line', tag: 'fit', minutes: 3, level: 3,
    status: 'live',
  },
  {
    ...
    cat: 'line', tag: 'fit', minutes: 4, level: 3,
    status: 'live',
  },
  {
  ...
  /* ---- form & perspective ---- */
  {
    ...
    cat: 'form', tag: 'auto', minutes: 4, level: 3,
    status: 'live',
  },
  {
    ...
    cat: 'form', tag: 'fit', minutes: 4, level: 3,
    status: 'live',
  },
  {
  ...
  },
  {
    ...
    cat: 'form', tag: 'auto', minutes: 3, level: 2,
    status: 'live',
  },
  {
    ...
    cat: 'form', tag: 'fit', minutes: 3, level: 2,
    status: 'live',
  },
  {
    ...
    cat: 'form', tag: 'fit', minutes: 3, level: 3,
    status: 'live',
  },
  {
    ...
    cat: 'form', tag: 'auto', minutes: 2, level: 1,
    status: 'live',
  },
  {
  ...
  /* ---- composition ---- */
  {
    ...
    cat: 'composition', tag: 'soft', minutes: 3, level: 1,
    status: 'live',
  },
  {
    ...
    cat: 'composition', tag: 'soft', minutes: 2, level: 1,
    status: 'live',
  },
  {
    ...
    cat: 'composition', tag: 'fit', minutes: 2, level: 1,
    status: 'live',
  },
  ...
  /* ---- observation & memory ---- */
  {
    ...
    cat: 'observation', tag: 'fit', minutes: 3, level: 3,
    status: 'live',
  },
  {
    ...
    cat: 'observation', tag: 'auto', minutes: 2, level: 1,
    status: 'live',
  },
  {
    ...
    cat: 'observation', tag: 'fit', minutes: 3, level: 2,
    status: 'live',
  },
  {
  ...
  },
  {
    ...
    cat: 'observation', tag: 'soft', minutes: 4, level: 2,
    status: 'live',
  },
];
