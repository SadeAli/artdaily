...
Trains: perspective, line. Run it: `python3 -m http.server 8080` in the repo
root, then open `/box-check/` — the drill loads its sdk, chrome and font
from above this folder. No build, no deps.
