...
Run it: `python3 -m http.server 8080` in the repo root one level up — not
in this folder, whose page loads its SDK, its chrome and its font from
above it — then open `http://localhost:8080/ellipse-in-plane/`. Plain
HTML/CSS/JS — no build, no deps.
