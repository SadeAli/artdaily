...
`http://localhost:8080/light-direction/` — serving this folder on its own leaves
the SDK, the page chrome and the font (all loaded from `../`) above the server
root, and the drill comes up bare. Zero build, zero deps.
