...
No build step, no dependencies. Serve the repo root rather than this folder,
since the SDK, the page chrome and the font are loaded from `../`:

```sh
cd ..                 # the artdaily repo root
python3 -m http.server 8080
# then visit http://localhost:8080/perspective/
```
