...
Run it: `python3 -m http.server 8080` in the repo root, not this folder — the SDK, the page
chrome and the font are loaded from above it — then open `localhost:8080/vp-hunt/`. No build
